...
clear;
common_path = 'Z:/Documents/dynamic_router_sim/8x8x8/';
...
%       figure_id = figure_id + 1;
    ...
    tmp = zeros(size(metric_list,2),size(routing_algorithm_list,2)*size(SA_list,2));
    for ii = 1 : 1 : size(metric_list,2)
    ...
    hb = bar(tmp);
    ylabel('percent');
    set(gca, 'XTickLabel',metric_list, 'XTick',1:numel(metric_list));
    set(gcf, 'PaperPositionMode','auto');
